...
th, td { border-width: 1px; padding: 0.9em; position: relative; text-align: left; }
...
@page { margin: 0; }
    ...
    <tr>
        <td style="border-right:0px;"  ><img src="<?php echo base_url();?>img/logo.jpeg" height="100" width="200"></td>
    ...
    <tr>
                <td >Tenant Name : </td>
                <td><?php echo $receiptList[0]->tenant_firstname;?></td>
     </tr>

    <tr>
        <td >Owner Name : </td>
        <td><?php echo $receiptList[0]->owner_firstname;?></td>
   </tr>
   ...
   <tr>
    ...
    <tr>
        ...
        <td><?php echo $receiptList[0]->payment_type;?></td>    
   </tr>

 <tr>
            <td>For :</td>
        <td><?php echo $receiptList[0]->description;
            echo " From : ".substr($receiptList[0]->installment_startdate,0,10);
            echo " To : ".substr($receiptList[0]->installment_enddate,0,10);
            ?></td>
   
   </tr>

 <tr>
        <td>  And the remaining amount of the rent is : </td>
        ...
        <aside>
            <p style="margin-left: 20px;font-family: Open Sans;">User Signature <span class="tab">Tenant Signature</span></p>  
           
        </aside>
</div>
     <!--   <div class="footer">
            <button id="print" class="btn btn-primary" >Print
        </div>
