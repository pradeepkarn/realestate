	...
	<div class="col s12" style="margin-top: 30px;">
	  <div class="card">
		<div class="card-content" style="padding-top: 5px;">
		  ...
		  <div>
			<!--<div class="card-header"><i class="fas fa-table"></i> قائمة العقود</div>-->
			<div class="card-body">
						   ...
						   <tr>
							...
							<td style="text-align: center;">
							  <div class="row">
								...
								<div class="col-2">
								  <a href="<?php echo base_url(CONTRACT_PANEL_URL.'editcontract').'/'.$contractList[$i]->cid.'?id=1';?>" title="تعديل" style="color: #607d8b;"><i class="fa fa-edit"></i></a>
								</div>
								<div class="col-2">
								  <a href="<?php echo base_url(CONTRACT_PANEL_URL.'editcontract').'/'.$contractList[$i]->cid.'?id=2';?>" title="تجديد" style="color: #607d8b;"><i class="fa fa-retweet"></i></a>
								</div>
								<div class="col-2">
								  <a onClick="return confirm(' هل تريد فعلا تعليق العقد ؟ ')" href="<?php echo base_url(CONTRACT_PANEL_URL.'contractsuspend').'/'.$contractList[$i]->cid.'/'.$contractList[$i]->unit_id;?>" title="تعليق" style="color: #607d8b;"><i class="fa fa-lock"></i></a>
								</div>
								<div class="col-2">
								  <a onClick="return confirm('هل ترغب بإنهاء العقد ؟ ')" href="<?php echo base_url(CONTRACT_PANEL_URL.'contractdelete').'/'.$contractList[$i]->cid.'/'.$contractList[$i]->unit_id;?>" title="حذف" style="color: #607d8b;"><i class="fa fa-remove"></i></a>
								</div>
							  </div>
							</td>
						</tr>
