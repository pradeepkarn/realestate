...
header h1 { background: #dee2e6; border-radius: 0.25em; color: #000; margin: 0 0 1em; padding: 0.5em 0; }
...
article, article address, table.meta, table.inventory { margin: 0 0 3em; padding-right: 40px; margin-bottom: 0px; }
  ...
  .hidden-print {
    ...
    <body>
        ...
        <article>
          ...
          <table  style="width:95%;height:100%;border: 0px;margin-top: 10px;margin-bottom: 15px;" >
    <tr>
        <td style="border-right:0px; text-align: left;border:0px;"  ><img src="<?php echo base_url();?>img/logo.png" height="20%" width="50%"></td>
        <td  style="text-align: right;border-left:0px;padding:5px;border:0px;"><br><br>مكتب ألوان الينابيع للعقارات  <br><br>الرياض 11325 ص.ب 370001<br><br>ت: 0114220325<br><br>ج: 0500598800</td>       
    </tr>
</table>
            </address>
   ...
   <tr>
    ...
    <td><?php if($receiptList[0]->insurance_paid_status!=0) { echo "قيمة التأمين"; }
    elseif ($receiptList[0]->brokerage_paid_status!=0){ echo "أجور السعي"; } ?>

     </td>
    <td><?php if($receiptList[0]->insurance_paid_status!=0) { echo $receiptList[0]->insurance_fees; }
    elseif ($receiptList[0]->brokerage_paid_status!=0){  echo $receiptList[0]->brokerage_fees;} ?></td>
   </tr>
...
<tr>
        <td>الوصف : </td>
        <td><?php  $date=date_create($receiptList[0]->amt_received_date); echo $receiptList[0]->description; echo "  on  "; echo date_format($date,"d/m/Y");// echo  date_format($receiptList[0]->amt_received_date,'d-m-Y');?></td>    
   </tr>
           ...
           <table  class="inventory" style="padding-right: 80px; margin-top: 10px; border:0px;border-color: #fff;">
            ...
            <p style="margin-left: 20px;font-family: Open Sans;text-align: center;"> توقيع المحاسب  </p></td>
