...
<input type="hidden" id="dbbalanceamount"  name="dbbalanceamount" readonly class="form-control">
  ...
  <div class="input-group-prepend">
    <span class="input-group-text" id="addon-wrapping">00.</span>
              ...
              <input type="text" name="amountreceived" id="amountreceived" placeholder="المبلغ المدفوع " autocomplete="off" tabindex="4" class="form-control" required >
  ...
  <div class="input-group-prepend">
    <span class="input-group-text" id="addon-wrapping">00.</span>
      ...
      <input type="text" class="form-control" id="installmentenddate" name="installmentenddate" placeholder="إلى"  readonly>
    </div>
 
 <div class="form-group col-md-6">
      <label for="installmentstartdate">عن الفترة من</label>
       <input type="text" class="form-control"  id="installmentstartdate" name="installmentstartdate" placeholder="عن الفترة من"  readonly>
    </div>
       </div> 
      ...
      $('#amountreceived').change(function(){
       ...
       //alert(s);
        if(received !='')
        {
          ...
          if(a<0)
          {
            alert("Received Amount is exceeding the Total amount");
