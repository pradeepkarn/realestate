    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-primary" style="border-color: #428bca;">
                <div class="panel-heading"> كشف حساب البنك  </div>
                <div class="panel-body">
  
 <div class="col-md-12 mx-auto">
  <section id="container">
    <h2> كشف حساب البنك  </h2>
...
?>
   ...
   <label for="buildingid"><font color=red>*</font>اسم العقار</label>
       <select class="form-control select2" style="width: 100%;" id="bankid" name="bankid" tabindex="1" required>
           ...
           <label>  من تاريخ : </label>
             <input type="date" id="startdate" name="startdate" class="form-control" style="width: 50%;margin-top: 20px;margin-left: 20px;margin-bottom: 20px;" 
             value="<?php if(isset($start)){ echo $start; } ?>">           
       
           <label> الى تاريخ : </label>
             <input type="date" id="enddate" name="enddate" class="form-control" style="width: 50%;margin-top: 20px;margin-bottom: 20px;"
              value="<?php if(isset($end)){ echo $end; } ?>">           
        </div>
      <input type="submit" name="submitbtn" id="submitbtn" tabindex="2" class="btn btn-primary"  value=" كشف حساب البنك  ">
