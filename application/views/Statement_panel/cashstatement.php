<?php //echo($end); die(); //echo "<Br><br><br>"; //print_r($maintenance);die(); ?>
<html>
<head>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="h1" style="background-color: #f5f5f5; text-align: center;">
                    <h6 class="card-title"> كشف حساب الصندوق
                ...
                <div class="table-responsive">
                    <table class="table table-lg" dir="rtl" >
                        ...
                        <tbody>
           <tr><td></td><td colspan="5"> الرصيد الافتتاحي  </td><td align="right" style="margin-left: 20px;"><?php echo($previousbalance[0]->previousbalance); ?> </td></tr>                
    <?php 
    ...
    while(date_format($startdat,'Y-m-d')<=date_format($enddat,'Y-m-d'))
{
    ...
    if(count($receipt)>0){
       ...
       $ss=date_create($receipt[$i]->amt_received_date);
        ...
        echo "<td>".substr($receipt[$i]->amt_received_date,0,10)."</td>";
 ...
 if(count($payment)>0){
        ...
        echo "<td>".substr($payment[$i]->payment_date,0,10)."</td>";
 ...
 ?>
                ...
                <div class="card-footer" style="width: 1100px;text-align: center;">  </div>
            </div>
        </div>
    </div>
</div>
