...
<div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"> المستأجرين / كشوف الحسابات</li>
          </ol>
<div class="container">
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-primary" style="border-color: #428bca;">
                <div class="panel-heading"> كشف حساب المستأجر  </div>
                <div class="panel-body">
  
 <div class="col-md-12 mx-auto">
  <section id="container">
    <h2>كشف حساب المستأجر </h2>
 ...
 $fcl=array('class'=>'cf','id'=>'form');
  echo form_open_multipart('Statement_controller/tenantstatementinfo',$fcl);
?>
 ...
 <div class="form-group">
      ...
      <input type="submit" name="submitbtn" id="submitbtn" tabindex="3" class="btn btn-primary"  value="كشف حساب المستأجر ">
