...
h1 { font: bold 100% 'Cairo', sans-serif; text-align: center; text-transform: uppercase; }
  ...
  .hidden-print {
    ...
    <tr>
            ...
            <table class="meta" dir="rtl">
                <tr>
                    <th style="width: 80px;"><label> رقم السند  #</label></th>
    ...
    <table class="inventory inventory1" dir="rtl" style="border: 1px #f8f8f8 solid;">
        ...
        <tr>
            <td> اسم المالك  : </td>
            <td><?php echo $paymentList[0]->owner_firstname;?>
                
                    <?php echo "  ".$paymentList[0]->owner_lastname;?>
                </td>
            </td>
        </tr>
        ...
        <tr>
            <td >رقم الوحدة : </td>
              <?php if(substr($paymentList[0]->unit_id,0,1)=="R") {
                                          $id=str_replace("R", " سكني  ", $paymentList[0]->unit_id);
                                        } 

                                        if(substr($paymentList[0]->unit_id,0,1)=="C") {
                                          $id=str_replace("C", " تجاري   ", $paymentList[0]->unit_id);
                                        } 
                                        ?>
            <td><?php echo $paymentList[0]->unit_type." - ".$id;?></td>       
        </tr>

        <tr>        
            <td> مبلغ و قدره : </td>
            <td><?php echo $paymentList[0]->payment_amount;?></td>
        </tr>
        ...
        <tr>
            <td>طريقة السداد : </td>
             <td><?php if($paymentList[0]->payment_type=="Cash")
        {
            echo "نقدا ";
        }
        else if($paymentList[0]->payment_type=="Card")
        {
            echo "بطاقة ";
        }
         else if($paymentList[0]->payment_type=="Cheque")
        {
            echo " شيك ";
        }

         else if($paymentList[0]->payment_type=="Transfer")
        {
            echo " تحويل  ";
        }
    ...
    <?php } ?>
        ...
        <tr>
            <td colspan="2">  وذلك قيمة قسط <?php echo $paymentList[0]->unit_type." - ".$id; ?> من الفترة <?php echo "".substr($paymentList[0]->payment_startdate,0,10);
            echo " الى  : ".substr($paymentList[0]->payment_enddate,0,10); ?> </td>
